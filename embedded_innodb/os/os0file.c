...
UNIV_STATIC os_event_t*	os_aio_segment_wait_events	= NULL;

/** The aio arrays for non-ibuf i/o and ibuf i/o, as well as sync aio. These
are NULL when the module has not yet been initialized. @{ */
UNIV_STATIC os_aio_array_t*	os_aio_read_array	= NULL;	/*!< Reads */
UNIV_STATIC os_aio_array_t*	os_aio_write_array	= NULL;	/*!< Writes */
UNIV_STATIC os_aio_array_t*	os_aio_ibuf_array	= NULL;	/*!< Insert buffer */
UNIV_STATIC os_aio_array_t*	os_aio_log_array	= NULL;	/*!< Redo log */
UNIV_STATIC os_aio_array_t*	os_aio_sync_array	= NULL;	/*!< Synchronous I/O */
/* @} */

/** Number of asynchronous I/O segments.  Set by os_aio_init(). */
UNIV_STATIC ulint	os_aio_n_segments	= ULINT_UNDEFINED;

/** If the following is TRUE, read i/o handler threads try to
wait until a batch of new read requests have been posted */
UNIV_STATIC ibool	os_aio_recommend_sleep_for_read_threads	= FALSE;
#endif /* UNIV_HOTBACKUP */
...
UNIV_STATIC os_mutex_t	os_file_count_mutex;
#endif /* !UNIV_HOTBACKUP */
...
UNIV_STATIC const char* srv_io_thread_op_info[SRV_MAX_N_IO_THREADS];
UNIV_STATIC const char* srv_io_thread_function[SRV_MAX_N_IO_THREADS];
